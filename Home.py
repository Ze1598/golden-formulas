...
st.markdown(
    ...
    Technical note: this web app is connected to his Notion workspace in real time meaning the content for these pages is dynamically generated via API calls,
"""
)